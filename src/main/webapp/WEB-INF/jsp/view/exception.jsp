...
<div class="message-box">
    <h1>${pageTitle}</h1>
    <h3 class="message-body-text">${exceptionMessage}</h3>
    <div class="buttons-con">
        <div class="action-link-wrap">
            <a onclick="history.back(-1)" class="link-button link-back-button">Back</a>
            <a href="${pageContext.request.contextPath}/home" class="link-button">Home</a>
            <a href="${pageContext.request.contextPath}/logout" class="link-button">Login</a>
        </div>
    </div>
</div>
</body>
